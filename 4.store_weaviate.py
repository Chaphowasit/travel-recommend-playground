...
def create_collection(client, collection_name):
    client.collections.create(f"{collection_name}")
...
def process_json_files(client, json_directory):
    ...
    if 'eat' in json_directory.lower():
        relevant_categories = {"RESTAURANT": ["foodAndDrink_Embedded", "foodAndDrink_Bridge"]}
    elif 'stay' in json_directory.lower():
        relevant_categories = {"ACCOMMODATION": ["accommodation_Embedded", "accommodation_Bridge"]}
...
def main():
    ...
    if client:    
        ...
        directories = ['eat/extract_json', 'stay/extract_json', 'do/extract_json']
